# Backup and Restore[¶](https://docs.rockylinux.org/zh/books/admin_guide/09-backups/#backup-and-restore)
...
![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) use the `tar` and `cpio` command to make a backup; 
 ![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) check their backups and restore data; 
 ![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) compress or decompress their backups.

![🏁](https://twemoji.maxcdn.com/v/latest/svg/1f3c1.svg) **backup**, **restore**, **compression**

**Knowledge**: ![⭐](https://twemoji.maxcdn.com/v/latest/svg/2b50.svg) ![⭐](https://twemoji.maxcdn.com/v/latest/svg/2b50.svg) ![⭐](https://twemoji.maxcdn.com/v/latest/svg/2b50.svg) 
...
## 概论[¶](https://docs.rockylinux.org/zh/books/admin_guide/09-backups/#_1)
