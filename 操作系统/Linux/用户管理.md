# User Management[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#user-management)
...
![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) add, delete or modify a **group** ; 
 ![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) add, delete or modify a **user** ; 
 ![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) know the syntax of the files associated with the management of groups and users ; 
 ![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) change the *owner* or the *group owner* of a file; 
 ![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) *secure* user accounts; 
 ![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) change identity.
...
## General[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#general)
...
## Group management[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#group-management)
...
### `groupadd` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#groupadd-command)
...
### Command `groupmod`[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#command-groupmod)
...
### `groupdel` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#groupdel-command)
...
### `/etc/group` file[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#etcgroup-file)
...
### `/etc/gshadow` file[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#etcgshadow-file)
...
## User management[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#user-management_1)

### Definition[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#definition)
...
### `useradd` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#useradd-command)
...
#### Default value for user creation.[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#default-value-for-user-creation)
...
### `usermod` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#usermod-command)
...
### `userdel` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#userdel-command)
...
### `/etc/passwd` file[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#etcpasswd-file)
...
### `/etc/shadow` file[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#etcshadow-file)
...
## File owners[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#file-owners)
...
### Modification commands[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#modification-commands)

#### `chown` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#chown-command)
...
### `chgrp` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#chgrp-command)
...
## Guest management[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#guest-management)

### `gpasswd` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#gpasswd-command)
...
### `id` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#id-command)
...
### `newgrp` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#newgrp-command)
...
## Securing[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#securing)

### `passwd` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#passwd-command)
...
### `chage` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#chage-command)
...
## Advanced management[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#advanced-management)
...
### `/etc/default/useradd` file[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#etcdefaultuseradd-file)
...
### `/etc/login.defs` file[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#etclogindefs-file)
...
### `/etc/skel` directory[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#etcskel-directory)
...
## Identity change[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#identity-change)

### `su` command[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#su-command)
...
#### Profile loading[¶](https://docs.rockylinux.org/zh/books/admin_guide/06-users/#profile-loading)
