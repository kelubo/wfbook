# File System[¶](https://docs.rockylinux.org/zh/books/admin_guide/07-file-systems/#file-system)
...
![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) manage partitions on disk; 
 ![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) use LVM for a better use of disk resources; 
 ![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) provide users with a filesystem and manage the access rights.

and also discover:

![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) how the tree structure is organized in Linux; 
 ![✔](https://twemoji.maxcdn.com/v/latest/svg/2714.svg) the different types of files offered and how to work with them;

![🏁](https://twemoji.maxcdn.com/v/latest/svg/1f3c1.svg) **hardware**, **disk**, **partition**, **lvm**, **linux**
...
## Partitioning[¶](https://docs.rockylinux.org/zh/books/admin_guide/07-file-systems/#partitioning)
...
![Breakdown into only 4 primary partitions](https://docs.rockylinux.org/books/admin_guide/images/07-file-systems-001.png)

![Breakdown into 3 primary partitions and one extended](https://docs.rockylinux.org/books/admin_guide/images/07-file-systems-002.png)
...
![Identification of partitions](https://docs.rockylinux.org/books/admin_guide/images/07-file-systems-003.png)
