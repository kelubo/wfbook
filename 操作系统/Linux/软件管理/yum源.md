...
# Adding a public mirror to Rocky's mirror manager[¶](https://docs.rockylinux.org/guides/mirror_management/add_mirror_manager/#adding-a-public-mirror-to-rockys-mirror-manager)

## Minimal requirements for public mirrors[¶](https://docs.rockylinux.org/guides/mirror_management/add_mirror_manager/#minimal-requirements-for-public-mirrors)
...
Our master mirror is `rsync://msync.rockylinux.org/rocky/mirror/pub/rocky/` For your first synchronization use a mirror near to you. You can find all official mirrors here: https://mirrors.rockylinux.org
...
## Setting up your mirror[¶](https://docs.rockylinux.org/guides/mirror_management/add_mirror_manager/#setting-up-your-mirror)
...
## What You Need[¶](https://docs.rockylinux.org/guides/mirror_management/add_mirror_manager/#what-you-need)

- An account on https://accounts.rockylinux.org/

## Creating a site[¶](https://docs.rockylinux.org/guides/mirror_management/add_mirror_manager/#creating-a-site)
...
## Configuring the site[¶](https://docs.rockylinux.org/guides/mirror_management/add_mirror_manager/#configuring-the-site)
...
## Create new host[¶](https://docs.rockylinux.org/guides/mirror_management/add_mirror_manager/#create-new-host)
...
## Update host[¶](https://docs.rockylinux.org/guides/mirror_management/add_mirror_manager/#update-host)
...
### Categories Carried[¶](https://docs.rockylinux.org/guides/mirror_management/add_mirror_manager/#categories-carried)
...
Examples: * `http://rocky.example.com` * `https://rocky.example.com` * `rsync://rocky.example.com`

## Wrap up[¶](https://docs.rockylinux.org/guides/mirror_management/add_mirror_manager/#wrap-up)
