...
Ubuntu Server为您的解决方案提供了一个灵活的基础，可以在各种硬件上运行，从小型虚拟机到企业级计算。 
...
Ubuntu Server支持各种64位架构和32位ARM。 

- amd64 (64-bit Intel/AMD)
  amd 64（64位Intel/AMD） 
- arm64 (64-bit Arm) arm 64（64位Arm） 
- armhf (32-bit Arm) Arm hf（32-bit Arm） 
- ppc64el (64-bit Power) ppc 64 el（64位电源） 
...
下面的数字适用于Ubuntu 24.04 Noble amd 64 ISO安装。其他版本、架构和部署方法可能略有不同。 

## Memory 存储器 

**Minimum RAM**: 1024 MB 最小RAM：1024 MB
