...
### Update a user[¶](https://docs.openstack.org/keystone/yoga/admin/cli-manage-projects-users-and-roles.html#update-a-user) 更新用户 ¶
...
### Create a role[¶](https://docs.openstack.org/keystone/yoga/admin/cli-manage-projects-users-and-roles.html#create-a-role) 创建角色 ¶
...
### Deleting implied roles[¶](https://docs.openstack.org/keystone/yoga/admin/cli-manage-projects-users-and-roles.html#deleting-implied-roles) 删除隐含角色 ¶
...
# Upgrading Keystone 升级 Keystone
...
## Before you begin[¶](https://docs.openstack.org/keystone/yoga/admin/upgrading.html#before-you-begin) 准备工作 ¶
...
## Upgrading with downtime[¶](https://docs.openstack.org/keystone/yoga/admin/upgrading.html#upgrading-with-downtime) 在停机的情况下升级 ¶
...
## Upgrading with minimal downtime[¶](https://docs.openstack.org/keystone/yoga/admin/upgrading.html#upgrading-with-minimal-downtime) 以最短的停机时间进行升级 ¶
...
### Rollback after a failed upgrade[¶](https://docs.openstack.org/keystone/yoga/admin/upgrading.html#rollback-after-a-failed-upgrade) 升级失败后回滚 ¶
...
## Upgrading without downtime[¶](https://docs.openstack.org/keystone/yoga/admin/upgrading.html#upgrading-without-downtime) 在不停机的情况下升级 ¶
...
### Using db_sync check[¶](https://docs.openstack.org/keystone/yoga/admin/upgrading.html#using-db-sync-check) 使用db_sync检查 ¶
