...
隔离变压器早期为欧洲国家用在电力行业，广泛用于电子工业或工矿企业、机床和机械设备中一般电路的控制电源、安全照明及指示灯的电源。
...
隔离变压器属于安全电源，一般用来机器维修、保养用，起保护、[防雷](https://baike.baidu.com/item/防雷)、[滤波](https://baike.baidu.com/item/滤波)作用。

一般（但并非全部）是指1：1的变压器。由于次级不和大地相连，次级任一根线与大地之间没有电位差，但使用安全。常用作维修电源。

控制变压器和电子管设备的电源也是隔离变压器。如电子管扩音机、电子管收音机与示波器，以及车床控制变压器等电源都是隔离变压器。如为了安全维修彩电常用1：1的隔离变压器。在空调中也有使用。

通常我们用的交流电源电压一根线和大地相连，另一根线与大地之间有220V的电位差。人接触会产生触电。而隔离变压器的次级不与大地相连，它的任意两线与大地之间没有电位差。人[接触](https://baike.baidu.com/item/接触/5692)任意一条线都不会发生触电，这样就比较安全。

隔离变压器的输出端跟输入端是完全“断路”隔离的，这样就有效的对变压器的输入端（电网供给的电源电压）起到了一个良好的过滤作用。从而给用电设备提供了纯净的电源电压。

防干扰。可广泛用于地铁、高层建筑、机场、车站、码头、工矿企业及隧道的输配电等场所。

隔离变压器是指输入绕组与输出绕组在电气上彼此隔离的变压器，用以避免偶然同时触及带电体（或因绝缘损坏而可能带电的金属部件）和大地所带来的危险，它的原理与普通干式变压器相同，也是利用[电磁感应](https://baike.baidu.com/item/电磁感应)原理，主要隔离一次电源回路，二次回路对地浮空，以保证用电安全。
...
隔离变压器一般是指1：1的变压器。由于次级不和地相连。次级任一根线与地之间没有电位差。使用安全。常用作维修电源。

隔离变压器不全是1：1变压器。控制变压器和电子管设备的电源也是隔离变压器。
...
##  	　　控制变压器：
 	...
 	![控制变压器和隔离变压器的区别](http://file.elecfans.com/web1/M00/95/69/pIYBAFz3ck-AdQ-VAABbWjmQpLg646.jpg)
...
## 自耦[变压器](http://m.elecfans.com/article/633489.html)简介
 	...
 	![自耦变压器和隔离变压器的区别是什么](http://file.elecfans.com/web1/M00/97/6C/pIYBAF0J-SWAIDaGAACDiBJCDjg989.jpg)
...
##  	　　隔离变压器简介
 	...
 	![自耦变压器和隔离变压器的区别是什么](http://file.elecfans.com/web1/M00/97/16/o4YBAF0J-PeAcfm0AADt9DwwGbs487.jpg)
...
​                                                        2017年12月19日 14:22 网络整理 作者： [用户评论（0）](http://www.elecfans.com/yuanqijian/bianyaqi/20171219605204.html#userComment)                                                   

**关键字：隔离变压器(25)变压器(1641)**

<iframe src="http://www1.elecfans.com/www/delivery/myafr.php?target=_blank&amp;cb=0.9682507630831481&amp;zoneid=216" scrolling="no" width="300" height="250" frameborder="0"></iframe>



 	　　隔离变压器是变压器中的一种类型，有很多人对隔离变压器可能不太了解。隔离变压器是指输入绕组与输出绕组带电气隔离的变压器，隔离变压器用以避免偶然同时触及带电体变压器的隔离是隔离原副边绕线圈各自的电流。那么隔离变压器如何选型呢？

 	　　![隔离变压器如何选型](http://www.elecfans.com/uploads/allimg/171219/2755783-1G219142303138.png)
...
##  	　　**2、看标识和包装**
 	...
 	　　变压器的标识，应当包含商标、型号和额定电气参数，或者会配有包含完整电气参数的说明书，有清楚的接线说明。
...
##  	**普通变压器与隔离变压器的区别**
 	...
 	![隔离变压器的原理及作用详细介绍](http://file.elecfans.com/web1/M00/46/07/o4YBAFqPdhqASmDCAAFBA0NisWM037.png)
...
##  	**隔离变压器的原理**
 	...
 	![隔离变压器的原理及作用详细介绍](http://file.elecfans.com/web1/M00/46/0C/pIYBAFqPdlyAFL6xAAG7WyqthMg662.png)
...
##  	**隔离变压器作用**
 	...
 	![隔离变压器的原理及作用详细介绍](http://file.elecfans.com/web1/M00/46/07/o4YBAFqPdj-AGMrzAAMIShSJlZ8692.png)
...
###  	**隔离变压器在交流电源输入端的特点：**
 	...
 	![隔离变压器的原理及作用详细介绍](http://file.elecfans.com/web1/M00/46/0C/pIYBAFqPdoKAPbgPAAHsJzRSDVs111.png)
...
​                                                        2018年01月25日 19:39 网络整理 作者： [用户评论（0）](http://www.elecfans.com/yuanqijian/bianyaqi/20180125623351.html#userComment)                                                   

**关键字：隔离变压器(25)变压器(1641)**

<iframe src="http://www1.elecfans.com/www/delivery/myafr.php?target=_blank&amp;cb=0.39090869424156327&amp;zoneid=216" scrolling="no" width="300" height="250" frameborder="0"></iframe>
...
​                                                        2017年12月19日 14:06 网络整理 作者： [用户评论（0）](http://www.elecfans.com/yuanqijian/bianyaqi/20171219605193_a.html#userComment)                                                   

**关键字：隔离变压器(25)变压器(1641)**

<iframe src="http://www1.elecfans.com/www/delivery/myafr.php?target=_blank&amp;cb=0.013765010286222235&amp;zoneid=216" scrolling="no" width="300" height="250" frameborder="0"></iframe>
 	...
 	　![隔离变压器工作原理详解](http://www.elecfans.com/uploads/allimg/171219/2755783-1G219140H54I.png)
