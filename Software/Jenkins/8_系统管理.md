...
# Reset the Jenkins administrator password  重置 Jenkins 管理员密码

Table of Contents 目录

- [Reset the administrator password
  重置管理员密码](https://www.jenkins.io/doc/book/system-administration/admin-password-reset-instructions/#reset-the-administrator-password)
- [Enable security 启用安全性](https://www.jenkins.io/doc/book/system-administration/admin-password-reset-instructions/#enable-security)

As a system administrator, you can reset the Jenkins admin password. In case you have forgotten or lost the password, this page provides instructions on how you can reset the admin password.
作为系统管理员，您可以重置 Jenkins 管理员密码。如果您忘记或丢失了密码，此页面提供了有关如何重置管理员密码的说明。

<iframe width="640" height="360" src="https://www.youtube.com/embed/_VhOMyWDIcY?rel=0" frameborder="0" allowfullscreen=""></iframe>

## Reset the administrator password 重置管理员密码
