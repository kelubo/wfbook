...
- - [ `` ](https://prometheus.io/docs/prometheus/latest/configuration/configuration/#scrape_config)
  ...
  - [ `` ](https://prometheus.io/docs/prometheus/latest/configuration/configuration/#puppetdb_sd_config)
...
![Exporter](https://www.prometheus.wang/exporter/static/prometheus-exporter.png)Exporter
...
![CAdvisor可视化：CPU总量](https://www.prometheus.wang/exporter/static/cadvisor-total-usage.png)CAdvisor可视化：CPU总量
...
![Target](https://www.prometheus.wang/exporter/static/prometheus_targetes_with_cadvisor.png)Target
...
![容器CPU使用率](https://www.prometheus.wang/exporter/static/promql_container_cpu_usage.png)容器CPU使用率
...
![容器网络接收量 字节/秒](https://www.prometheus.wang/exporter/static/container_network_receive_bytes_total.png)容器网络接收量 字节/秒
...
![容器网络传输量 字节/秒](https://www.prometheus.wang/exporter/static/container_network_transmit_bytes_total.png)容器网络传输量 字节/秒
...
![容器文件系统读取速率 字节/秒](https://www.prometheus.wang/exporter/static/container_fs_reads_bytes_total.png)容器文件系统读取速率 字节/秒
...
![容器文件系统写入速率 字节/秒](https://www.prometheus.wang/exporter/static/container_fs_writes_bytes_total.png) 
...
![MySQLD Exporter实例状态](https://www.prometheus.wang/exporter/static/mysqld_exporter_target_stats.png)MySQLD Exporter实例状态
