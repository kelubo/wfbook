...
## 环境准备[¶](https://docs.rockylinux.org/zh/books/learning_rsync/07_rsync_unison_use/#_2)
...
## Rocky Linux 8 安装unison[¶](https://docs.rockylinux.org/zh/books/learning_rsync/07_rsync_unison_use/#rocky-linux-8-unison)
...
## Fedora 34 安装unison[¶](https://docs.rockylinux.org/zh/books/learning_rsync/07_rsync_unison_use/#fedora-34-unison)
...
## 演示[¶](https://docs.rockylinux.org/zh/books/learning_rsync/07_rsync_unison_use/#_3)

**我们的需求是 —— Rocky Linux 8的 /dir1/ 目录自动同步到Fedora 34的 /dir2/ 目录 ；同时Fedora 34的 /dir2/ 目录自动同步到Rocky Linux 8 的 /dir1/ 目录**

### 配置Rcoky Linux 8[¶](https://docs.rockylinux.org/zh/books/learning_rsync/07_rsync_unison_use/#rcoky-linux-8)
...
### 配置Fedora 34[¶](https://docs.rockylinux.org/zh/books/learning_rsync/07_rsync_unison_use/#fedora-34)
