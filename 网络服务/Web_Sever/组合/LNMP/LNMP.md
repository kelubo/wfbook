...
# PHP and PHP-FPM[¶](https://docs.rockylinux.org/zh/guides/web/php/#php-and-php-fpm)
...
## Generalities[¶](https://docs.rockylinux.org/zh/guides/web/php/#generalities)
...
## Choose a php version[¶](https://docs.rockylinux.org/zh/guides/web/php/#choose-a-php-version)
...
## PHP cgi mode[¶](https://docs.rockylinux.org/zh/guides/web/php/#php-cgi-mode)
...
### Installation[¶](https://docs.rockylinux.org/zh/guides/web/php/#installation)
...
### Configuration[¶](https://docs.rockylinux.org/zh/guides/web/php/#configuration)

### Apache integration[¶](https://docs.rockylinux.org/zh/guides/web/php/#apache-integration)
...
## PHP-FPM (FastCGI)[¶](https://docs.rockylinux.org/zh/guides/web/php/#php-fpm-fastcgi)

As we highlighted earlier in this document, there are many advantages to switching web hosting to php-fpm mode.

### Installation[¶](https://docs.rockylinux.org/zh/guides/web/php/#installation_1)
...
### Configuration[¶](https://docs.rockylinux.org/zh/guides/web/php/#configuration_1)
...
#### Configuring the way to access php-fpm processes[¶](https://docs.rockylinux.org/zh/guides/web/php/#configuring-the-way-to-access-php-fpm-processes)
...
#### Static or dynamic configuration[¶](https://docs.rockylinux.org/zh/guides/web/php/#static-or-dynamic-configuration)
...
#### Process status[¶](https://docs.rockylinux.org/zh/guides/web/php/#process-status)
...
#### Logging long requests[¶](https://docs.rockylinux.org/zh/guides/web/php/#logging-long-requests)
...
### NGinx integration[¶](https://docs.rockylinux.org/zh/guides/web/php/#nginx-integration)
...
### Apache integration[¶](https://docs.rockylinux.org/zh/guides/web/php/#apache-integration_1)
...
### Solid configuration of php pools[¶](https://docs.rockylinux.org/zh/guides/web/php/#solid-configuration-of-php-pools)
...
### Opcache configuration[¶](https://docs.rockylinux.org/zh/guides/web/php/#opcache-configuration)
