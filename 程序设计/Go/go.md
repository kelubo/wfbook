...
![image2](http://image.iswbm.com/image-20200317211914020.png)
...
| ---- | ------ | ---- | ------------- | -------------- | ------------------------------------------- |
| 1    | uint   | 无   | 32或64        | 4或8           | 与计算机系统的位数有关                      |
| 2    | uint8  | 无   | 8             | 1              | 0 到 255                                    |
| 3    | uint16 | 无   | 16            | 2              | 0 到 65535                                  |
| 4    | uint32 | 无   | 32            | 4              | 0 到 4294967295                             |
| 5    | uint64 | 无   | 64            | 8              | 0 到 18446744073709551615                   |
| 6    | int    | 有   | 32或64        | 4或8           | 与计算机系统的位数有关                      |
| 7    | int8   | 有   | 8             | 1              | -128 到 127                                 |
| 8    | int16  | 有   | 16            | 2              | -32768 到 32767                             |
| 9    | int32  | 有   | 32            | 4              | -2147483648 到 2147483647                   |
| 10   | int64  | 有   | 64            | 8              | -9223372036854775808 到 9223372036854775807 |
...
整数部分和小数部分均由10进制表示法表示。还有另一种表示方法，在其中加入指数部分。指数部分由“E”或“e”以及一个带正负号的10进制数组成。
...
**float32**，也即常说的单精度，存储占用4个字节，也即4*8=32位，其中1位用来符号，8位用来指数，剩下的23位表示尾数

![img](../../Image/f/float32)

**float64**，也即我们熟悉的双精度，存储占用8个字节，也即8*8=64位，其中1位用来符号，11位用来指数，剩下的52位表示尾数

![img](../../Image/f/float64.jpg)
...
![image1](http://image.iswbm.com/20200106201856.png)
