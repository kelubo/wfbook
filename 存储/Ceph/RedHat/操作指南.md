...
- ​						如需更多信息，请参阅 Red Hat Ceph Storage Storage 策略指南中的 [CRUSH 管理](https://access.redhat.com/documentation/zh-cn/red_hat_ceph_storage/7/html-single/storage_strategies_guide/#crush_administration)一章。 				
