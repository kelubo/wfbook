# Cryptography[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#lab-9-cryptography)

## Objectives[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#objectives)
...
## Common Cryptography terms and definitions[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#common-cryptography-terms-and-definitions)

### Cryptography[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#cryptography)
...
### Cryptanalysis[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#cryptanalysis)
...
### Cryptology[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#cryptology)
...
### Encryption[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#encryption)
...
### Decryption[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#decryption)

Decryption is the reverse of encryption; it is the transformation of encrypted data back into an intelligible form.

### Cipher[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#cipher)
...
### Algorithm[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#algorithm)
...
### Digital Signature[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#digital-signature)
...
### Cryptographic Protocols[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#cryptographic-protocols)
...
## Exercise 1[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#exercise-1)

### GnuPG[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#gnupg)
...
## Exercise 2[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#exercise-2)

### Key Administration[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#key-administration)
...
## Exercise 3[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#exercise-3)

### Digital signatures[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#digital-signatures)
...
## Exercise 4[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#exercise-4)
...
## Exercise 5[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#exercise-5)

### sshd[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#sshd)
...
## Exercise 6[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#exercise-6)

### ssh[¶](https://docs.rockylinux.org/zh/labs/security/lab9-cryptography/#ssh)
